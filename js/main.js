...
const answer4 = new Answer(4, 'Object.key(shape1) === Object.keys(shape2)', false, 1);
const card1 = new Card (1, 'What expression will return if 1. let shape = { x:10, y:20 } and' +
...
const card2 = new Card (2, 'What is the output of the following JavaScript code?', 1, [answer5, answer6, answer7, answer8]);

const answer9 = new Answer(9, 'Object.keys(point)', true, 3);
...
const card13 = new Card(13, 'What will be the value of "point.x" after executing ' +
    'the following code? let point = {x: 100, y: 200}; let point2 = point; point2.x = 0;', 1, [answer49, answer50, answer51, answer52]);
...
const card14 = new Card(14, 'How can you list the values assigned to all properties ' +
    'of the person object { name: "Emily", age: 25, city: "New York" }?', 1, [answer53, answer54, answer55, answer56]);

const answer57 = new Answer(57, 'person[name]', false, 15);
const answer58 = new Answer(58, 'person->name', false, 15);
const answer59 = new Answer(59, 'name', false, 15);
const answer60 = new Answer(60, 'person["name"]', true, 15);
const card15 = new Card(15, 'What is the correct way to access the name property ' +
    'in the person object { "name": "Jane Doe" }?', 1, [answer57, answer58, answer59, answer60]);

const answer61 = new Answer(61, 'null 100', false, 16);
const answer62 = new Answer(62, 'undefined 100', true, 16);
const answer63 = new Answer(63, 'undefined undefined', false, 16);
const answer64 = new Answer(64, '100 undefined', false, 16);
const card16 = new Card(16, 'What will appear on the console after executing the following code? let point = {x: 100, y: 200}; let point2 = {...point, z: 300}; delete point.x; ' +
    'console.log(${point.x} ${point2.x});', 1, [answer61, answer62, answer63, answer64]);
...
const card17 = new Card(17, 'What is the expression that will add a new property color with a value ' +
    'of "red" to the car object { model: "Tesla", year: 2022 }?', 1, [answer65, answer66, answer67, answer68]);
...
const card18 = new Card(18, `What is the output of the following code:
        let numbers = [1, 2, 3, 4]; let newNumbers = numbers.map(function(number)
        { return number * 2; }); console.log(newNumbers);`, 1, [answer69, answer70, answer71, answer72]);
...
const card19 = new Card(19, `What will appear on the console after executing the following code?
        let animal = { species: "dog", breed: "Labrador" };
        let pet = { ...animal, name: "Buddy" };
        animal.species = "cat";
        console.log("\${pet.species} \${pet.breed} \${pet.name}");`, 1, [answer73, answer74, answer75, answer76]);
...
const card20 = new Card(20, 'What is the correct way to access the value of property "brand" in object "phone"?', 1, [answer77, answer78, answer79, answer80]);
...
const card21 = new Card(21, 'Which of the following expressions returns true if the object "point" has a property "x"?', 1, [answer81, answer82, answer83, answer84]);
...
const card22 = new Card(22, 'What will be the value of x after the following code is executed? let x = 10;\n' +
    'function add5(num) { num += 5;\n' +
    'return num;\n' +
    '}\n' +
    'x = add5(x);\n', 1, [answer85, answer86, answer87, answer88]);

const answer89 = new Answer(89, 'ReferenceError: prop1 is not defined', false, 23)
const answer90 = new Answer(90, 'undefined', true, 23)
const answer91 = new Answer(91, 'null', false, 23)
const answer92 = new Answer(92, '"value1"', false, 23)
const card23 = new Card(23, 'What is the output of the following code? ' +
    'let object1 = { prop1: "value1"}; let object2 = Object.create(object1); ' +
    'object2.prop2 = "value2"; delete object2.prop1; console.log(object2.prop1);', 1, [answer89, answer90,answer91,answer92]);
...
const card24 = new Card(24, 'What is the output of the following code? ' +
    'let obj1 = {a: 10, b: 20}; let obj2 = Object.create(obj1); ' +
    'obj2.c = 30; console.log(obj2.a+""+obj2.b+""+obj2.c);', 1, [answer93, answer94,answer95,answer96]);
...
const card25 = new Card(25, 'What will be the output of the following JavaScript code? ' +
    'let x = 10; let y = 20; let z = 30; let obj = {x, y, z}; ' +
    'console.log(Object.keys(obj));', 1, [answer97, answer98,answer99,answer100]);
...
const card26 = new Card(26, 'What will be the output of the following code? ' +
    'let arr = [1, 2, 3, 4]; let arr2 = arr;arr2.push(5); ' +
    'console.log(arr);', 1, [answer101, answer102,answer103,answer104]);
...
const card27 = new Card(27, 'What is the value of property "z" after executing the following code? let obj = {x: 100, y: 200}; ' +
    'let obj2 = Object.create(obj); obj2.z = 300;', 1, [answer105, answer106,answer107,answer108]);
...
const answer128 = new Answer(128, 'Object.defineProperties(point, {z: 300});', false, 32);
...
const cardBox1 = new CardBox(1,[card1, card2, card3, card4, card5, card6, card7, card8, card9, card10, card11,
    card12, card13, card14, card15, card16, card17, card18, card19, card20, card21, card22, card23, card24, card25, card26, card27, card28, card29, card30, card31, card32, card33, card34, card35, card36, card37, card38,
    card39, card40, card41, card42]);
console.log(cardBox1);

const cP = new CardPool();
cP.loadCard(card1);
cP.loadCard(card2);
cP.loadCard(card3);
cP.loadCard(card4);
